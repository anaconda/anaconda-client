...
class ChannelEvents:
    ...
    @staticmethod
    def created(api, app_name: str | None, channel_path: str, privacy: str, error: bool = False) -> None:
    ...
    @staticmethod
    def created_exists(api, app_name: str | None, channel_path: str, privacy: str, error: bool = False) -> None:
    ...
    @staticmethod
    def accessed(api, app_name: str | None, channel_path: str, error: bool = False) -> None:
    ...
    @staticmethod
    def limit(api, app_name: str | None, channel_path: str) -> None:
    ...
    @staticmethod
    def removed(api, app_name: str | None, channel_path: str, error: bool = False) -> None:
...
class ShareEvents:
    ...
    @staticmethod
    def share(api, app_name: str | None, channel_path: str, user: str, role: str, error: bool = False) -> None:
    ...
    @staticmethod
    def unshare(api, app_name: str | None, channel_path: str, user: str, error: bool = False) -> None:
