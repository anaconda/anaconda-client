...
def test_upload_bad_package(registry):
...
def test_upload_bad_package_no_register(registry):
    registry.register(method='HEAD', path='/', status=200)
    registry.register(method='GET', path='/user', content='{"login": "eggs"}')
...
def test_upload_conda(registry):
    registry.register(method='HEAD', path='/', status=200)
    registry.register(method='GET', path='/user', content='{"login": "eggs"}')
    registry.register(method='GET', path='/dist/eggs/foo/0.1/osx-64/foo-0.1-0.tar.bz2', status=404)
...
def test_upload_conda_v2(registry):
    registry.register(method='HEAD', path='/', status=200)
    registry.register(method='GET', path='/user', content='{"login": "eggs"}')
...
def test_upload_use_pkg_metadata(registry):
    registry.register(method='HEAD', path='/', status=200)
    registry.register(method='GET', path='/user', content='{"login": "eggs"}')
    registry.register(method='GET', path='/dist/eggs/mock/2.0.0/osx-64/mock-2.0.0-py37_1000.conda', status=404)
    registry.register(method='GET', path='/package/eggs/mock', content={'package_types': ['conda']})
...
def test_upload_pypi_with_conda_package_name_allowed(registry):
    registry.register(method='HEAD', path='/', status=200)
    registry.register(method='GET', path='/user', content='{"login": "eggs"}')
...
def test_upload_conda_package_with_name_override_fails(registry):
    registry.register(method='HEAD', path='/', status=200)
    registry.register(method='GET', path='/user', content='{"login": "eggs"}')
...
def test_upload_pypi_with_random_name(registry):
    registry.register(method='HEAD', path='/', status=200)
    registry.register(method='GET', path='/user', content='{"login": "eggs"}')
...
def test_upload_project(registry):
...
@pytest.mark.xfail(reason='anaconda-project removed')
def test_upload_notebook_as_project(registry):
    registry.register(method='HEAD', path='/', status=200)
    registry.register(method='GET', path='/user/eggs', content='{"login": "eggs"}')
    registry.register(method='GET', path='/user', content='{"login": "eggs"}')
...
def test_upload_notebook_as_package(registry):
...
@pytest.mark.xfail(reason='anaconda-project removed')
def test_upload_project_specifying_user(registry):
    registry.register(method='HEAD', path='/', status=200)
...
@pytest.mark.xfail(reason='anaconda-project removed')
def test_upload_project_specifying_token(registry):
    registry.register(method='HEAD', path='/', status=200)
    registry.register(
        method='GET',
        path='/user/eggs',
...
def test_upload_interactive_no_overwrite(registry, mock_upload_bool_input):
...
def test_upload_interactive_overwrite(registry, mock_upload_bool_input):
    registry.register(method='HEAD', path='/', status=200)
    registry.register(method='GET', path='/user', content='{"login": "eggs"}')
    registry.register(method='GET', path='/dist/eggs/foo/0.1/osx-64/foo-0.1-0.tar.bz2', content='{}')
...
def test_upload_private_package(registry):
    registry.register(method='HEAD', path='/', status=200)
    registry.register(method='GET', path='/user', content='{"login": "eggs"}')
    registry.register(method='GET', path='/dist/eggs/foo/0.1/osx-64/foo-0.1-0.tar.bz2', status=404)
    registry.register(method='GET', path='/package/eggs/foo', content='{}', status=404)
...
def test_upload_private_package_not_allowed(registry):
    registry.register(method='HEAD', path='/', status=200)
    registry.register(method='GET', path='/user', content='{"login": "eggs"}')
    registry.register(method='GET', path='/dist/eggs/foo/0.1/osx-64/foo-0.1-0.tar.bz2', status=404)
    registry.register(method='GET', path='/package/eggs/foo', content='{}', status=404)
